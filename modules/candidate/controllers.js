$(document).ready(function () {
    ...
    angular.module('um_CandidateController', ['um_CandidateService', 'um_JobService', 'um_StatusService','um_SessionService', 'um_UserService', 'um_RegisterService', 'um_EngagementService', 'um_GoogleMapService','um_SettingService', 'um_InviteService'])
    .controller("candidateController", function ($scope, $route, $timeout, $interval, $routeParams, CandidateService, JobService, StatusService, SessionService, UserService, RegisterService, EngagementService, GoogleMapService, SettingService, InviteService, $modal) {
